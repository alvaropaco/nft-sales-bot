...
const saleTx: ParsedConfirmedTransaction = {
  ...
  meta: {
    ...
    logMessages: [
      ...
      "Program 11111111111111111111111111111111 invoke [2]",
      "Transfer: insufficient lamports 535541880, need 199000000000",
      "Program 11111111111111111111111111111111 failed: custom program error: 0x1",
      "Program M2mx93ekt1fmXSVkTrUL9xVFHkmME8HTUi5Cyc5aF7K consumed 31706 of 200000 compute units",
      "Program M2mx93ekt1fmXSVkTrUL9xVFHkmME8HTUi5Cyc5aF7K failed: custom program error: 0x1",
    ],
    postBalances: [
      537553320, 0, 100148868680, 0, 4679361921, 2039280, 0, 622546587905,
      2234160, 122636106118, 183253627269, 21196708033, 7189216410, 1057098000,
      1, 1461600, 5616720, 3654000, 953185920, 1009200, 898174080, 58542103680,
      1141440,
    ],
    postTokenBalances: [
      {
    ...
    preBalances: [
      537558320, 0, 100148868680, 0, 4679361921, 2039280, 0, 622546587905,
      2234160, 122636106118, 183253627269, 21196708033, 7189216410, 1057098000,
      1, 1461600, 5616720, 3654000, 953185920, 1009200, 898174080, 58542103680,
      1141440,
    ],
  ...
  transaction: {
    message: {
      ...
      instructions: [
        {
          accounts: [
            "L9xDD9dUAcM8r5NHF6SJZRtd4FBpiDUJCbkKF2msWeL",
            "11111111111111111111111111111111",
            "HrMZjUm31CANQdP61abasiMvYpEYc8dAtuDNxWmzZSkq",
            "57wdSxZi3tA2jfFKvjaZbbkFR5G9yj51QbuHgbsunCTt",
            "7NcXXsn5MBUi3nfaE8VMJeZEUFnzcc9btHCFTHBoyrzG",
            "autMW8SgBkVYeBgqYiTuJZnkvDZMVU2MHJh9Jh7CSQ2",
            "E8cU1WiRWjanGxmn96ewBgk9vPTcL6AEZ1t6F6fkgUWe",
            "AXz5FXk9xuSj4dL5SCQTezPXL6rNZwqKyV8aWHTtf5s1",
            "autMW8SgBkVYeBgqYiTuJZnkvDZMVU2MHJh9Jh7CSQ2",
        ...
        },
        {
          accounts: [
            ...
            "11111111111111111111111111111111",
            "91suNRSJkMbTtNj7U7oQUxQ4TEu9jHJEiFAY3RTU8BUx",
            "HrMZjUm31CANQdP61abasiMvYpEYc8dAtuDNxWmzZSkq",
            "57wdSxZi3tA2jfFKvjaZbbkFR5G9yj51QbuHgbsunCTt",
            "7NcXXsn5MBUi3nfaE8VMJeZEUFnzcc9btHCFTHBoyrzG",
            "6i9pirs3gRj1XsGVks3SHsQcnoAES2mwFYmhKAkexgYw",
            "autMW8SgBkVYeBgqYiTuJZnkvDZMVU2MHJh9Jh7CSQ2",
            "E8cU1WiRWjanGxmn96ewBgk9vPTcL6AEZ1t6F6fkgUWe",
            "rFqFJ9g7TGBD8Ed7TPDnvGKZ5pWLPDyxLcvcH2eRCtt",
            "AXz5FXk9xuSj4dL5SCQTezPXL6rNZwqKyV8aWHTtf5s1",
            "autMW8SgBkVYeBgqYiTuJZnkvDZMVU2MHJh9Jh7CSQ2",
            "2mxszBFYzWnwUN3MsYf96ENtNXRFtxE66rVR71j2gTpi",
            "autMW8SgBkVYeBgqYiTuJZnkvDZMVU2MHJh9Jh7CSQ2",
            "TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA",
            "11111111111111111111111111111111",
    ...
    signatures: [
      "5D3kshpCeGwhxBBPRQXmD48XvENJKXSwR79v6ceZBRAS41d2JeqMv3d2Yy9aZ1LADwQdDiop4ErRihnfYudfRJBy",
    ],
  },
};
